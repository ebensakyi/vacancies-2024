...
const Reference = ({ data }: any) => {
  ...
  const add = async () => {
    try {
      if (phone == "" || address == "" || occupation == "" || fullName == "")
  ...
  const next = async () => {
    ...
    await router.push(`/applicant/submit-application?next=true`);
    return;
  };
              ...
              <div className="form-actions mt-10">
                <div className="col-md-12" style={{ textAlign: "end" }}>
                  ...
                  >
                    ...
                    {data.staffTypes.includes(1) ? (
                      <Link
                        href="/applicant/publication"
                        type="button"
